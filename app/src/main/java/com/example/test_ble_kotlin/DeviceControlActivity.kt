...
//                    broadcastUpdate("Connected "+ device?.name)
                    for (i in 0..gatt!!.services.size){
                        Log.d("gatttest : services",gatt!!.services[i].uuid.toString())
                        Log.d("gatttest : device",gatt!!.device.uuids.toString())
//                        Log.d("gatttest : device",gatt!!.services[i].)
                    }
                }
                else -> {
